...
const chessIcon = '/chess.png';
const computerIcon = '/computer.png';
const lightningIcon = '/lightning-bolt.png';
const friendIcon = '/friendship.png';
const tournamentIcon = '/trophy.png';
const variantsIcon = '/strategy.png';
